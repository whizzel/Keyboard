        ...
        <div className="bg-black/80 border border-black rounded-[5px] rounded-t-[8px] h-[278px]">
          <div className="-space-y-1 -translate-y-1 rounded-[5px] overflow-hidden">
            ...
            <Row>
              ...
              <Key keyCode={KEYCODE.MetaLeft} width={62} className="flex items-center justify-center">
                {"Alt"}
              </Key>

              <Key keyCode={KEYCODE.Space} width={324}  className="flex justify-center items-center ">
                <span className="text-xs">{"Vishal"}</span>
              </Key>

              <Key keyCode={KEYCODE.MetaRight} className="flex items-center justify-center">
                {"Alt"}
              </Key>
